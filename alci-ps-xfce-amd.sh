...
sudo pacman -S xdg-user-dirs xorg-server xorg-xinit xterm xf86-video-amdgpu xfce4 lightdm lightdm-gtk-greeter networkmanager network-manager-applet thunar-archive-plugin xfce4-whiskermenu-plugin xfce4-pulseaudio-plugin pavucontrol --noconfirm
...
sudo pacman -Syy vulkan-radeon vulkan-mesa-layers libva-mesa-driver vulkan-icd-loader lib32-mesa lib32-vulkan-radeon lib32-vulkan-icd-loader lib32-vulkan-mesa-layers mesa-demos xorg-xdpyinfo amd-ucode mesa-utils --noconfirm
